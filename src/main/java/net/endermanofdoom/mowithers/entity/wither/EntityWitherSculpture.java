...
public class EntityWitherSculpture extends EntityLivingBase
{
    ...
    public static final DataParameter<Byte> STATUS = EntityDataManager.<Byte>createKey(EntityWitherSculpture.class, DataSerializers.BYTE);
    public static final DataParameter<Rotations> HEAD_ROTATION = EntityDataManager.<Rotations>createKey(EntityWitherSculpture.class, DataSerializers.ROTATIONS);
    public static final DataParameter<Rotations> BODY_ROTATION = EntityDataManager.<Rotations>createKey(EntityWitherSculpture.class, DataSerializers.ROTATIONS);
    public static final DataParameter<Rotations> LEFT_ARM_ROTATION = EntityDataManager.<Rotations>createKey(EntityWitherSculpture.class, DataSerializers.ROTATIONS);
    public static final DataParameter<Rotations> RIGHT_ARM_ROTATION = EntityDataManager.<Rotations>createKey(EntityWitherSculpture.class, DataSerializers.ROTATIONS);
    public static final DataParameter<Rotations> LEFT_LEG_ROTATION = EntityDataManager.<Rotations>createKey(EntityWitherSculpture.class, DataSerializers.ROTATIONS);
    public static final DataParameter<Rotations> RIGHT_LEG_ROTATION = EntityDataManager.<Rotations>createKey(EntityWitherSculpture.class, DataSerializers.ROTATIONS);
    ...
    public EntityWitherSculpture(World worldIn)
    {
        super(worldIn);
    ...
    public EntityWitherSculpture(World worldIn, double posX, double posY, double posZ)
    {
        this(worldIn);
    ...
    {
        fixer.registerWalker(FixTypes.ENTITY, new ItemStackDataLists(EntityWitherSculpture.class, new String[] {"ArmorItems", "HandItems"}));
    }
